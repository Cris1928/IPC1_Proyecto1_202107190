...
public class clase2 extends JFrame implements ActionListener {
    ...
    JScrollPane scrolle;
    JScrollPane scroll;
    DefaultTableModel modu;
    JTable tablau;
    Object[] newr;

    public static Usuario[] usuarios = new Usuario[50];
    public static int arrtu[] = new int[50];
...
//private static String  nombre = "";
 ...
 public clase2() {
    ...
    public void botones() {
        ...
        boton2.setFont(new Font("Ubuntu", Font.BOLD, 15));
...
//    
                                ...
                                System.out.println("------------------------------------");
                                int idlu = Integer.parseInt(value_id.toString());//aqui convierto el strig a int y obtengo el dato ingresado
                                //  Object[] newr ={(Long) obyeto_value.get("ID"),(String) obyeto_value.get("Usuario"),(String) obyeto_value.get("Password"),(Long) obyeto_value.get("Tipo"),(String) obyeto_value.get("Facultad"),(String) obyeto_value.get("Carrera")};
