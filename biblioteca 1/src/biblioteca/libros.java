...
public class libros extends JPanel implements ActionListener {
    ...
    public Object[] newr;
    public static int arrt[] = new int[100];
    int counter;
        ...
        cajas1.addKeyListener(new KeyListener() {//aqui llamo a los metodos abstractos que posee el keylistener
            ...
            public void keyTyped(KeyEvent ei) {//kytyped me ayuda a saber que caracter esta ingresando a la caja de texto
                ...
                if (!Character.isDigit(c)) { //si lo que ingresamos es un caracter entonces se consumira y no aparecera en la caja
                    ei.consume();
                    cajas1.setBackground(Color.red);
...
if (tabla.getValueAt(i, 0).equals(id)) {
 JOptionPane.showMessageDialog(null, "El libro ya existe");
                                mod.removeRow(i);// introduzco el objeto array a la tabla
                                counter--; }}
                    ...
                    public void actionPerformed(ActionEvent e) {//compezamos a declarar la accion que tendra el boton 
                        if (counter < 100) {
                            ...
                            for (Object obyeto_inarray : arrayobyeto) {
                                ...
                                Object[] values = {String.valueOf(libro_nuevo.idLibro), libro_nuevo.titulo, libro_nuevo.autor, getTipoLibro(libro_nuevo.tipo), String.valueOf(libro_nuevo.copias), String.valueOf(libro_nuevo.disponible), String.valueOf(libro_nuevo.ocupados)};

                                mod.addRow(values);
                                reportes.mod2.addRow(values);

                                counter++;//el contador sera igual a contador +1
                                arrt[counter] = libro_nuevo.idLibro;
